...
<header>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="navbar-right active"><a href="#"> Kasir</a></li>
			</ul>
		</div>
	</nav>
	</header>
	...
	while($d = mysqli_fetch_assoc($data)){
		...
		<form action="../controller/update_kasir.php" method="post" name="form1" onSubmit="return validasi()">
        ...
        <div class="form-group">
            ...
            <input  type="text" class="form-control" id="stock" name="stok" required value="<?php echo $d['item_stock']; ?>">
        </div>
        <div class="form-group">
            <label for="pwd">Harga Barang</label>
            <input  type="text" class="form-control " id="harga" name="harga"required value="<?php echo $d['item_price']; ?>">
        </div>
        <button name="Submit" type="submit" class="btn btn-primary" style="margin-top:2em;">Update</button>
		<a href="Kasir.php"><input type="button" value="Back" class="btn btn-danger" style="margin-top:2em;"></button></a>
		</form>
	<?php 
	}
	?>
